...
extension SyntaxSpecifier {
	private static let treeSitterQueryCaptureMap: [String: SyntaxSpecifier] = [
        ...
        "keyword.type": .keyword(nil),
        "keyword.coroutine": .keyword(nil),
        "keyword.repeat": .keyword(nil),
        "keyword.conditional": .keyword(.conditional),
        "keyword.exception": .keyword(nil),
        "keyword.modifier": .keyword(nil),
        "keyword.directive": .keyword(nil),
		"label": .context,
		"method": .definition(.method),
        "number": .literal(.number(nil)),
        "number.float": .literal(.number(.float)),
		"operator": .operator(nil),
		"parameter": .identifier(.parameter),
		"property": .identifier(.property),
		"punctuation.delimiter": .punctuation(.delimiter),
        "punctuation.special": .punctuation(nil),
        "punctuation.bracket": .punctuation(nil),
		"repeat": .keyword(.control),
		"string": .literal(.string(nil)),
		"string.escape": .literal(.string(.escape)),
        "string.regex": .literal(.regularExpression),
        "string.regexp": .literal(.regularExpression),
